...
\label{metaexample}
    ...
    Suppose $T$ is an agent and $p=\langle r_0,o_0,a_0,\ldots,r_n,o_n,a_n$ is an ROA-play.
    ...
    by $X$ in which the agent is $T$. $e$ can compute $(T,e_{s_n},R_{s_n})$
    and $(T,e_{s_{n+1}},R_{s_{n+1}})$
