...
\label{rewardagentforignoringrewardsexample}
    (Reward Agent for Ignoring Rewards) Let $E_0$ be a traditional RL environment.
    We define a new environment $E$ as follows.
    \begin{enumerate}
        \item (Version 1)
        ...
        give the agent reward $-1$. Let $o_n$ be the observation which $E_0$ would
