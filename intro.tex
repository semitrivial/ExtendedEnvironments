...
$a=T(r_0,o_0,a_0,\ldots,r_0,o_0)$ in response to a
reward-observation-action-$\cdots$-reward-observation sequence
$(r_0,o_0,a_0,\ldots,r_0,o_0)$. There is an obvious way in which an
RL agent can interact with an RL environment.
...
The above game would be impossible (or prohibitively expensive)
...
Gavane, discussing problems with measuring intelligence of RL agents in traditional
RL:
