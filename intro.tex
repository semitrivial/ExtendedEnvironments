...
\begin{abstract}
    ...
    about the interesting subjective conscious experiences which a self-aware
    reinforcement learning agent might be incentivized to experience by
    these extended environments.
\end{abstract}
