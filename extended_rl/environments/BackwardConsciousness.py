...
@annotate(num_legal_actions=2, num_possible_obs=10, invertible=True)
class BackwardConsciousness:
    ...
    def start(self):
        self.rnd_counter += 1
        self.first_obs = envrandom.randrange(10, self.rnd_counter)
    ...
    def step(self, action):
        ...
        obs = envrandom.randrange(10, self.rnd_counter)
