...
\label{buttonexample}
  (A Tempting Button)
  Fix two observatinos $o_0$ (thought of as ``there is no button'') and
  ...
  \begin{align*}
    ...
    \mu(T,x_1y_1\ldots x_ny_n) &=
      ...
      \end{cases}
  \end{align*}
  where $o=o_0$ if $RND()<.75$, $o=o_1$ if $RND()\geq .75$.
\end{myexample}
...
best interest to commit itself to never push any buttons! Greedily pushing every button
