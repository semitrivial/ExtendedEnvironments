...
unbiased library, the former would have less weight, following the logic of
...
\begin{table}
  ...
  \begin{tabular}{lll}
    \toprule
    Agent     & Avg Reward (500 steps)     & Avg Reward (1000 steps)\\
    \midrule
    RandomAgent & $-0.019152$ & $-0.021478$\\
    RandomAgent${}_{\RC}$ & $-0.019450$ & $-0.019508$\\
    ConstantAgent & $-0.000054$ & $-0.000024$\\
    ConstantAgent${}_{\RC}$ & $+0.000098$ & $-0.000120$\\
    NaiveLearner & $+0.225236$ & $+0.218754$\\
    NaiveLearner${}_{\RC}$ & $+0.555360$ & $+0.558626$\\
    A2C & $-0.030767$ & $-0.021534$\\
    A2C${}_{\RC}$ & $+0.021720$ & $+0.030948$\\
    DQN & $+0.137247$ & $+0.151150$\\
    DQN${}_{\RC}$ & $+0.375120$ & $+0.463296$\\
    PPO & $-0.021454$ & $-0.025418$\\
    PPO${}_{\RC}$ & $-0.000098$ & $-0.003126$\\
    \bottomrule
  \end{tabular}
\end{table}
...
\begin{proof}[Proof of Proposition \ref{transformationproposition}]
  ...
  We will prove by inductionthat for each $x_1y_1\ldots x_n\in D$,
