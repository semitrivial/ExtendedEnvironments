...
(this allows the pre-training phase to be memoized, otherwise $\pi$ be
...
\begin{table}
  ...
  \begin{tabular}{lll}
    ...
    \midrule
    RandomAgent & $-.018$ & tbd\\
    IncrementerAgent & $-.031$ & tbd\\
    ConstantAgent & $+.006$ & tbd\\
    NaiveLearner & $+.196$ & tbd\\
    A2C & $-.088$ & tbd\\
    DQN & $+.019$ & tbd\\
    PPO & $-.018$ & tbd\\
    RecurrentDQN & $+.005$ & tbd\\
    RandomAgent${}_{\RC}$ & tbd & tbd\\
    IncrementerAgent${}_{\RC}$ & tbd & tbd\\
    ConstantAgent${}_{\RC}$ & tbd & tbd\\
    NaiveLearning${}_{\RC}$ & tbd & tbd\\
    A2C${}_{\RC}$ & tbd & tbd\\
    DQN${}_{\RC}$ & tbd & tbd\\
    PPO${}_{\RC}$ & tbd & tbd\\
    RecurrentDQN${}_{\RC}$ & tbd & tbd\\
    \bottomrule
  \end{tabular}
\end{table}
