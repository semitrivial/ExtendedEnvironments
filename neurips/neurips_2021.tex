...
\subsection{An extended environment with a counterintuitive winning strategy}
...
\begin{itemize}
  ...
  \item A2C, DQN, and PPO agents (with MLP policy)
    ...
    (to ensure reproducibility), PPO's n\_steps and batch\_size (to facilitate the conversion
...
\begin{enumerate}
  \item Did you include the code, data, and instructions needed to reproduce the main experimental results (either in the supplemental material or as a URL)?
    ...
    as supplemental material. In the text itself, where we discuss experimental results,
    we refer the user to specific files in the library containing instructions for how
    to replicate those experimental results.}
